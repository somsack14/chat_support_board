                    ...
                    <div>
                        ...
                        <div class="sb-menu-mobile">
                            ...
                            <ul>
                                ...
                                <?php if (defined('SB_WHATSAPP')) echo '<li><a data-value="whatsapp" class="sb-btn-icon" data-sb-tooltip="' . sb_('Send a WhatsApp message template') . '"><i class="sb-icon-social-wa"></i></a><li>' ?>
                                <li>
